...
export const ContributionGraph = ({
  ...
  const contextValue = useMemo<ContributionGraphContextType>(
    () => ({
      data,
      weeks,
      blockMargin,
...
export const ContributionGraphBlock = ({
  ...
  return (
    <rect
      className={cn(
        'data-[level="0"]:fill-heat-0',
        'data-[level="1"]:fill-heat-1',
        'data-[level="2"]:fill-heat-2',
        'data-[level="3"]:fill-heat-3',
        'data-[level="4"]:fill-heat-4',
        className
      )}
